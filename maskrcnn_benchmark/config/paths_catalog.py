...
class DatasetCatalog(object):
    ...
    DATASETS = {
       "coco_userv2_zi": {
         "img_dir": "userv2_zi",
         "ann_file": "annotations/userv2_zi.json"
       },
       "coco_userv2_cai": {
         "img_dir": "userv2_cai",
         "ann_file": "annotations/userv2_cai.json"
       },
       "coco_userv1_food": {
         "img_dir": "userv1_food",
         "ann_file": "annotations/userv1_food.json"
       },
       "coco_userv2_plants": {
         "img_dir": "userv2_plants",
         "ann_file": "annotations/userv2_plants.json"
       },
       "coco_userv1_book": {
         "img_dir": "userv1_book",
         "ann_file": "annotations/userv1_book.json"
       },
       "coco_userv1_zhubao": {
         "img_dir": "userv1_zhubao",
         "ann_file": "annotations/userv1_zhubao.json"
       },
       "coco_userv2_dishes3": {
         "img_dir": "userv2_dishes3",
         "ann_file": "annotations/userv2_dishes3.json"
       },
       "coco_userv2_dishes2": {
         "img_dir": "userv2_dishes2",
         "ann_file": "annotations/userv2_dishes2.json"
       },
       "coco_userv2_dishes1": {
         "img_dir": "userv2_dishes1",
         "ann_file": "annotations/userv2_dishes1.json"
       },
       "coco_userv2_meizhuang": {
         "img_dir": "userv2_meizhuang",
         "ann_file": "annotations/userv2_meizhuang.json"
       },
       "coco_head_side": {
         "img_dir": "head_side",
         "ann_file": "annotations/head_side.json"
       },
       "coco_head_back": {
         "img_dir": "head_back",
         "ann_file": "annotations/head_back.json"
       },
       "coco_head_front": {
         "img_dir": "head_front",
         "ann_file": "annotations/head_front.json"
       },
       "coco_noise": {
         "img_dir": "noise",
         "ann_file": "annotations/noise.json"
       },
       "coco_book_noise": {
         "img_dir": "book_noise",
         "ann_file": "annotations/book_noise.json"
       },
       "coco_cat09": {
         "img_dir": "cat09",
       ...
       "coco_dishes": {
         "img_dir": "dishes",
         "ann_file": "annotations/dishes.json"
       },
       "coco_hetianyu": {
         "img_dir": "hetianyu",
       ...
       "coco_userv1_jiaju": {
         "img_dir": "userv1_jiaju",
         "ann_file": "annotations/userv1_jiaju.json"
       },
       "coco_jiadian1": {
         "img_dir": "jiadian1",
       ...
       "coco_userv1_xiangbao": {
         "img_dir": "userv1_xiangbao",
         "ann_file": "annotations/userv1_xiangbao.json"
       },
       "coco_cat07": {
         "img_dir": "cat07",
       ...
       "coco_snapshot": {
         "img_dir": "snapshot",
         "ann_file": "annotations/snapshot.json"
       },
       "coco_scene": {
         "img_dir": "scene",
         "ann_file": "annotations/scene.json"
       },
       "coco_jiulei": {
         "img_dir": "jiulei",
       ...
       "coco_body": {
         "img_dir": "body",
         "ann_file": "annotations/body.json"
       },
       "coco_cat08": {
         "img_dir": "cat08",
       ...
       "coco_userv1_wanju": {
         "img_dir": "userv1_wanju",
         "ann_file": "annotations/userv1_wanju.json"
       },
       "coco_jiaju": {
         "img_dir": "jiaju",
       ...
       "coco_porn": {
         "img_dir": "porn",
         "ann_file": "annotations/porn.json"
       },
       "coco_cat06": {
         "img_dir": "cat06",
         "ann_file": "annotations/cat06.json"
       },
       "coco_binary_test_det": {
         "img_dir": "binary_test_det",
         "ann_file": "annotations/binary_test_det.json"
       },
       "coco_tushu": {
         "img_dir": "tushu",
       ...
       "coco_userv1_jiadian": {
         "img_dir": "userv1_jiadian",
         "ann_file": "annotations/userv1_jiadian.json"
       },
       "coco_neiyiku_4k": {
         "img_dir": "neiyiku_4k",
       ...
       "coco_userv1_meizhuang": {
         "img_dir": "userv1_meizhuang",
         "ann_file": "annotations/userv1_meizhuang.json"
       },
       "coco_jiadian2_extra": {
       ...
       "coco_corner": {
         "img_dir": "corner",
         "ann_file": "annotations/corner.json"
       },
       "coco_shouji_extra": {
       ...
       "coco_ad_pic": {
         "img_dir": "ad_pic",
         "ann_file": "annotations/ad_pic.json"
       },
       "coco_cat04": {
         "img_dir": "cat04",
       ...
       "coco_animals": {
         "img_dir": "animals",
         "ann_file": "annotations/animals.json"
       },
       "coco_cat10": {
         "img_dir": "cat10",
       ...
       "coco_outdoor": {
         "img_dir": "outdoor",
         "ann_file": "annotations/outdoor.json"
       },
       "coco_meizhuang_2w": {
         "img_dir": "meizhuang_2w",
       ...
       "coco_plants": {
         "img_dir": "plants",
         "ann_file": "annotations/plants.json"
       },
       ...
       "coco_userv1_shoe": {
         "img_dir": "userv1_shoe",
         "ann_file": "annotations/userv1_shoe.json"
       },
       "coco_bag": {
         "img_dir": "bag",
       ...
       "coco_extra_20190715": {
         "img_dir": "extra_20190715",
         "ann_file": "annotations/extra_20190715.json"
       },
       "coco_shipinbuchong": {
