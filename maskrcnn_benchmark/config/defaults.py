...
_C.INPUT.VERTICAL_FLIP_PROB_TRAIN = 0.2
_C.INPUT.FLIP_90_PROB_TRAIN = 0.01
_C.INPUT.CROP_PROB_TRAIN = 0.2
_C.INPUT.BLUR_PROB_TRAIN = 0.2
_C.INPUT.CONTRAST_PROB_TRAIN = 0.2
_C.INPUT.HSV_PROB_TRAIN = 0.2
