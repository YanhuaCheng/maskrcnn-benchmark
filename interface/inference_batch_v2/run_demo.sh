...
#########################################################################
##retinanet
CUDA_VISIBLE_DEVICES=0 python demo.py --config-file "./configs/inference_full_product11_faster_rcnn_retinanet_R-50-FPN_1x.yaml" --root-dir "../../demo/badcase_imgs" DEPLOY.TOPN 1 OUTPUT_DIR "save_result" MODEL.WEIGHT ../../pretrained_models/.torch/models/full_product_det11_retinanet3.0_batchaug_0200000.pth
#faster rcnn
