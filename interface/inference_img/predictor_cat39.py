...
class COCODemo(object):
    ...
    CATEGORIES = ['cat00_bg','cat01_gaogenxie','cat01_liangxie','cat01_yundongxie','cat02_kuabao','cat02_qianbao',
                  'cat02_xinglvxiang','cat03_baozhuanghe','cat03_gongju','cat03_hufupin','cat04_shangyi',
                  'cat04_taozhuang','cat04_xiaku','cat05_dapingmu','cat05_xiaopingmu','cat06_car','cat06_jixiefangzhen',
                  'cat06_muyingjiaju','cat06_rendongwu','cat06_yizhiwanju','cat06_yueqi','cat07_book','cat08_daizhuang',
                  'cat08_guanzhuang','cat08_hezhuang','cat08_sanzhuang','cat09_baijian','cat09_peishi','cat09_shoubiao',
                  'cat10_chuangshafa','cat10_chufangpeijian','cat10_chufangzhujian','cat10_dengju','cat10_shuibeishuihu',
                  'cat10_weiyushebei','cat10_wuneibaijian','cat10_xiangui','cat10_zhuoyi','cat11_huojiyanju','cat11_qita']
