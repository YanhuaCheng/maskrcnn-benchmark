...
TAG=2.0
NGPUS=4
python -m torch.distributed.launch --nproc_per_node=$NGPUS tools/train_net.py --config-file "configs/full_product39_faster_rcnn_R_50_FPN_1x.yaml"  DATASETS.DATASET_PREFIX ${DATASET_PREFIX} OUTPUT_DIR log/log_${DATASET_PREFIX}_${TAG}
