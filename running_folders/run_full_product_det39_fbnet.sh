...
TAG="fbnet_chamv1a_float16"
NGPUS=2
python -m torch.distributed.launch --nproc_per_node=$NGPUS tools/train_net.py --config-file "configs/full_product39_faster_rcnn_fbnet_chamv1a.yaml"  DATASETS.DATASET_PREFIX ${DATASET_PREFIX} OUTPUT_DIR log/log_${DATASET_PREFIX}_${TAG} DTYPE "float16"
