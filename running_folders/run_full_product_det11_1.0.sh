...
TAG=1.0
NGPUS=2
python -m torch.distributed.launch --nproc_per_node=$NGPUS tools/train_net.py --config-file "configs/gn_baselines/e2e_faster_rcnn_R_50_FPN_1x_gn.yaml"  DATASETS.DATASET_PREFIX ${DATASET_PREFIX} OUTPUT_DIR log/log_${DATASET_PREFIX}_${TAG} DTYPE "float16"
